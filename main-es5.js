...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(formBuilder, contact, toastr) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.message = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]); // Initialize FormGroup using FormBuilder
        ...
        value: function onSubmit() {
          ...
          var toEmail = {
            ...
            address: contactValue.emailAddress
          };
          var fromEmail = {
            name: "no-reply-analysim",
            address: "analysim@outlook.com"
          };
          var subject = contactValue.subject;
          var bodyHtml = "<p>" + contactValue.message + "</p>";
          var bodyText = contactValue.message;
          this.contact.sendEmail(toEmail, fromEmail, [], [], subject, bodyText, bodyHtml).subscribe(function (result) {
            _this.toastr.success('Email has been sucessfully sent', 'Email Sent');
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AppComponent_Template_form_ngSubmit_136_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](184, "\xD7");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](267, "\xD7");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](308, "\xD7");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](339, " \xA9 2020 Hieu Dinh ");
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrModule"].forRoot()]]
    });
  ...
  function srcAppContactServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ContactService = /*#__PURE__*/function () {
      ...
      _createClass(ContactService, [{
        key: "sendEmail",
        value: function sendEmail(to, from, cc, bcc, subject, bodyText, bodyHtml) {
          var emailBody = {
            From: {
              Name: from.name,
          ...
          cc.forEach(function (x) {
            return emailBody.CcAddresses.push({
              Name: x.name,
              Address: x.address
            });
          });
          bcc.forEach(function (x) {
            return emailBody.BccAddresses.push({
              Name: x.name,
              Address: x.address
            });
          });
          return this.http.post(this.api, emailBody).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (body) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Hieu Dinh\Documents\Github\Resume2\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
